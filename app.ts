...
const infoArr: Array<string> = ['Thumbnail', 'Age', 'Name', 'City'];

function showTableHeader(infoArr: Array<string>) {
...
function showLoadingIndicator() {
  ...
  loadingIndicator?.setAttribute('class', 'visible');
}

function hideLoadingIndicator() {
  const loadingIndicator = document.getElementById('loadingIndicator');
  loadingIndicator?.setAttribute('class', 'hidden');
}
